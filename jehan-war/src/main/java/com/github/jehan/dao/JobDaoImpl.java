...
import com.github.jehan.services.JerseyClientFactory;
...
/**
 * Implementation of {@link com.github.jehan.dao.JobDao}
 */
@Repository
...
// ------------------------- private constants -------------------------
	...
	/** The resolver used to find an {@link com.fasterxml.jackson.databind.ObjectMapper}. */
	@Autowired
	 ...
	 * {@inheritDoc}
	 *
	 * @see com.github.jehan.dao.JobDao#findAll(com.github.jehan.model.Instance)
	 */
	@Override
